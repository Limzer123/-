...
<%@ page import="Utils.SessionCounter"%>
<%
	...
	<div id="box_autoplay">
    	<div class="list">
        	<ul>
            	...
            	<li><img src="${pageContext.request.contextPath}/client/ad/ad3.jpg" width="900" height="335" /></li>
            	<li><img src="${pageContext.request.contextPath}/client/ad/ad4.jpg" width="900" height="335" /></li>
...
<!-- 公告板和本周热卖  end -->
    <div><center>在线人数为：<%=SessionCounter.getActiveSessions() %></center></div>		
<!--5. 网上书城底部 start -->
